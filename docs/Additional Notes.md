...
# Constants
This library uses a variety of constants, either as macros or enums. To ensure your constants' names are different to those defined in this library you should check the "Macros" script, which contains all the constants for this project.